...
export const descriptionMap = {
  ...
  aboutApp: "Version numbers, developer credits, and the story behind sitalOS.",
  ...
  browserApp: "Surf the web from inside your virtual desktop with the built-in browser.",
  yukiDevTools: "Dev Tools loads IT Tools in a themed iframe and keeps it synced with sitalOS CSS variables.",
  ...
  steamApp: "Your game library, wrapped in a Steam-style storefront interface built right into sitalOS.",
  ...
  yukiCode: "A Monaco-powered code editor built into sitalOS, based on the same engine that runs Visual Studio Code.",
  jsDosApp:
